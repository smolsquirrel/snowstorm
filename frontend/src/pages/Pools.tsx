					...
					<Grid item>
						<Box component={Paper} sx={{ height: "60vh" }}>
							...
							<Typography variant="subtitle2">
								* distribution among top 10 pools
							</Typography>
						</Box>
					</Grid>
				</Grid>
				<Grid item container direction="column" xl={6} lg={12}>
					<Grid item>
						...
						>
							...
							<Tooltip title="User overlap between the top 10 pools in the last 7 days.">
								<InfoIcon />
							</Tooltip>
						</Box>
					</Grid>
			...
			<Grid item container direction="column" marginTop={2}>
				<Grid item>
					<Box
						...
						sx={{ borderTop: 10, borderColor: "#ee5253" }}
					>
						<Typography variant="h4">Pool Volume Change by Platform (7D)</Typography>
						<Tooltip title="Percent change in volume between the past week (the last 7 days) and the week before that. Considers the top 10 pools of the past week.">
							<InfoIcon />
						</Tooltip>
					</Box>
				</Grid>
			...
			<Grid item container direction="column">
				<Grid item>
					<Box
						...
						sx={{ borderTop: 10, borderColor: "#ee5253" }}
					>
						<Typography variant="h4">WAVAX-X Pools Volume Percentage</Typography>
						<Tooltip title="Percentage of volume going into WAVAX pairs. A chain's native token (or its wrapped version) is usually one of the top tokens to LP with.">
							<InfoIcon />
						</Tooltip>
					</Box>
				</Grid>
				<Grid item>
					<Box component={Paper} sx={{ height: "50vh" }}>
						<SimpleLine data={applyDateRange(range, wavax)} type="Stable Percent" />
					</Box>
				</Grid>
				<Grid item>
					<Slider
